...
import 'package:super_mario/block.dart';
import 'package:super_mario/cloud.dart';
import 'package:super_mario/gameOver.dart';
import 'package:super_mario/jumping_mario.dart';
import 'package:super_mario/mushroom.dart';
import 'package:super_mario/pole.dart';
import 'Mario.dart';
import 'buttons.dart';
import 'dollar.dart';
...
class _HomepageState extends State<Homepage> {
  ...
  void CheckifAteMushrooom() {
    if ((marioX - mushX).abs() < 0.05 && (marioY - mushY).abs() < 0.05) {
      ...
      setState(() {
        marioSize = 100;
        playSound("audios/mushroom_sound.mp3");
        mushX = 2;
  ...
  void releaseDollar1() {
    money += 10;
    playSound("audios/coin_sound.mp3");
